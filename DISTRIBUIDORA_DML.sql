...
--TABLA Barrio_Colonia
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (38, 'José Ángel Ulloa', 110);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (41, 'José Arturo Duarte', 110);
	...
	-- Insertar Barrio_Colonia 1
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (185, 'Aserradero Santa María', 19);
	...
	-- Insertar Barrio_Colonia 17
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (201, 'Barrio San Ramón', 19);

	-- Insertar Barrio_Colonia 18
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (202, 'Barrio San Sebastián', 19);

	-- Insertar Barrio_Colonia 19
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (203, 'Barrio Santa Lucía', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (212, 'Barrio_Colonia Boquín', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (217, 'Barrio_Colonia Concepción', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (221, 'Barrio_Colonia Francisco Morazán', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (224, 'Barrio_Colonia Lomas del Río', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (230, 'Barrio_Colonia Mejía Fiallos', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (239, 'Barrio_Colonia San Martín', 19);
	...
	INSERT INTO Barrio_Colonia (Id_Colonia, descripcion, Municipio_id)
	VALUES (246, 'TR. San Martín-Río Humuya', 19);
...
--Tabla Empresa
	...
	INSERT INTO Empresa (Id_Empresa,nombre,ruc,Id_direccion) 
	VALUES (13, 'SOCIÉTÉ SUNLINE SL','08010000000004', 8);
	...
	INSERT INTO Empresa (Id_Empresa,nombre,ruc,Id_direccion) 
	VALUES (20, 'PRODUCTOS QUÍMICOS ECCODET','08010000000011', 4);
...
--TABLA TipoProducto
	...
	-- Insert 9
	INSERT INTO TipoProducto (Id_tipo_producto, nombre)
	VALUES (9, 'Productos para lavandería');
...
--TABLA PROVEEDOR 
	...
	-- Insert 4
	INSERT INTO Proveedor (Id_proveedor, Id_Empresa, descripcion, fecha_inicio_proveedor)
	VALUES (4, 13, 'SOCIÉTÉ SUNLINE', '2022-10-01');
...
--Tabla Compra
	...
	-- Insert 2
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (2, 'Adquisición de suministros de limpieza', '2023-08-02 11:30:00', 'EMP035', 2);
	...
	-- Insert 4
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (4, 'Adquisición de artículos de limpieza', '2023-08-04 09:15:00', 'EMP037', 4);
	...
	-- Insert 6
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (6, 'Adquisición de suministros de limpieza', '2023-08-06 13:20:00', 'EMP039', 6);
	...
	-- Insert 8
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (8, 'Adquisición de artículos de limpieza', '2023-08-08 12:00:00', 'EMP041', 8);
	...
	-- Insert 10
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (10, 'Adquisición de suministros de limpieza', '2023-08-10 11:50:00', 'EMP035', 10);
	...
	-- Insert 12
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (12, 'Adquisición de artículos de limpieza', '2023-08-12 09:30:00', 'EMP037', 2);
	/*
	-- Insert 13
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	...
	-- Insert 14
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (14, 'Adquisición de suministros de limpieza', '2023-08-14 13:40:00', 'EMP039', 4);
	...
	-- Insert 16
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (16, 'Adquisición de artículos de limpieza', '2023-08-16 12:50:00', 'EMP041', 6);
	...
	-- Insert 18
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (18, 'Adquisición de suministros de limpieza', '2023-08-18 11:15:00', 'EMP035', 8);
	...
	-- Insert 20
	INSERT INTO Compra (N_compra, descripcion, fecha, COD_empleado, PXP)
	VALUES (20, 'Adquisición de artículos de limpieza', '2023-08-20 09:00:00', 'EMP037', 10);
	*/
--TABLA PEDIDO
	-- Insert 1
...
--Tabla Factura
	...
	-- Insert 9
	 INSERT INTO Factura (No_Factura, Sucursal_id, fecha_emision_factura, sub_total_venta, isv, descuento, total_venta, observaciones, numero_orden, medio_pago_id, tipopago, pago_del_cliente, cambio, cliente, Id_vendedor, Id_Empresa)
	VALUES ('000-001-01-00711024', 3, '2023-08-22T11:40:00', 90.00, 9.00, 6.00, 93.00, 'Cliente solicitó envío a domicilio', 9, 1, 2, 93.00, 0.00, 9, 9, 1);
...
--TABLA Historico_Entregas
	...
	-- Insert 2
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (2, '000-001-01-00711017', '2023-08-15T14:20:00', 'Entregado', 'Cliente recibió el pedido en buen estado', 2);

	-- Insert 3
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (3, '000-001-01-00711018', '2023-08-16T09:45:00', 'Pendiente', 'Cliente ausente, dejó notificación', 3);

	-- Insert 4
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (4, '000-001-01-00711019', '2023-08-17T12:15:00', 'Entregado', 'Cliente solicitó entrega en horario específico', 1);
	...
	-- Insert 6
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (6, '000-001-01-00711021', '2023-08-19T11:30:00', 'Pendiente', 'Dirección incompleta, se intentará nuevamente', 2);

	-- Insert 7
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (7, '000-001-01-00711022', '2023-08-20T15:45:00', 'Entregado', 'Cliente autorizó dejar el pedido con vecino', 3);
	...
	-- Insert 10
	INSERT INTO Historico_Entregas (Id_entrega, No_Factura, fecha_entrega, estado_entrega, observaciones, repartidor)
	VALUES (10, '000-001-01-00711025', '2023-08-23T09:20:00', 'Pendiente', 'Cliente solicitó cambio de dirección, se coordinará nueva entrega', 4);
